...
$(document).ready(function() { $("#selectPa1").select2(); });
$(document).ready(function() { $("#selectPa2").select2(); });
$(document).ready(function() { $("#selectPa3").select2(); });
$(document).ready(function() { $("#selectPa4").select2(); });
$(document).ready(function() { $("#selectPa5").select2(); });
      
$(document).ready(function() { $("#selectFm1").select2(); });
$(document).ready(function() { $("#selectFm2").select2(); });
$(document).ready(function() { $("#selectFm3").select2(); });
$(document).ready(function() { $("#selectFm4").select2(); });
$(document).ready(function() { $("#selectFm5").select2(); });
			...
			if (optionManquante != "lol"){ 
				for (i=1; i<6; i++){
					if (i != parseInt(id[id.length - 1])){
						...
						document.getElementById("selectPa" + i).add(opt, where);
					}
				}	
			}
	    	//var blocListe = document.getElementById('blocResultat');
	    	//blocListe.innerHTML = optionManquante;
	    }
	    else {
						...
						if (optionManquante_ < select_other.options[1].text){
							...
							if (optionManquante_ > select_other.options[select_other.options.length-1].text){
								...
								for (j=0; j<select_other.options.length - 1; j++){
									var option_1 = select_other.options[j].text;
									var option_2 = select_other.options[j+1].text;
									if ((option_1 < optionManquante_) && (optionManquante_ < option_2)){
										where = j+1;
									}
								}
							}
			...
			if (optionManquante_ != "lol"){
				for (i=1; i<6; i++){
			  		if (i != parseInt(id[id.length - 1])){
						...
						texte += "<br />";
						texte += "premier choix non nul : " + select_other.options[1].text;
