	...
	<div class="container">
		...
		<form:form action="/admin/save-config" method="POST" commandName="when">
			...
			<div class="row">
				<div class="span4">
					<h2>
						Parcours <a href="/admin/config/modif/new/parcours" class="btn btn-info"><i class="icon-white icon-plus"></i></a>
					</h2>
					<br />
				...
				<div class="span4">
					<h2>
						Filières <a href="/admin/config/modif/new/filieres" class="btn btn-info"><i class="icon-white icon-plus"></i></a>
					</h2>
					<br />
