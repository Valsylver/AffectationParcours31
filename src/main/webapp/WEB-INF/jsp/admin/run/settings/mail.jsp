		...
		<div class="row">
				...
				<ul class="nav nav-list">
					...
					<c:choose>
						<c:when test="${number == 1 }">
							<li class="active"><a href="/admin/run/settings/mail1">Premier mail</a></li>
							<li><a href="/admin/run/settings/mail2">Second mail</a></li>
						</c:when>
						<c:otherwise>
							<li><a href="/admin/run/settings/mail1">Premier mail</a></li>
							<li class="active"><a href="/admin/run/settings/mail2">Second mail</a></li>
						</c:otherwise>
					</c:choose>
			...
			<div class="span6">
				<form:form action="/admin/run/settings/process-mail-edition" method="post" commandName="mail" class="well form-horizontal span6">
					...
					<form:input id="object" path="object" class="span2" />
