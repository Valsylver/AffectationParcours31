	...
	<div class="container">
		...
		<div class="row">
					...
					<c:forEach var="spec" items="${allIc}">
						<c:choose>
							<c:when test="${spec.abbreviation == abbreviation}">
								<li class="active"><a href="/admin/parcours/details/${abbreviation}/choix1">${spec.abbreviation}</a></li>
							</c:when>
							<c:otherwise>
			...
			<div class="span7">
				<ul class="nav nav-pills">
					<c:forEach var="i" begin="1" end="5" step="1">
						<c:choose>
							<c:when test="${i == order}">
								<li class="active">
									<a href="/admin/parcours/details/${abbreviation}/choix${i}">Choix ${i}</a>
								</li>
							</c:when>
							<c:otherwise>
								<li>
				...
				<span class="lead">
					<a href="/admin/config/modif/parcours/${abbreviation}" >
