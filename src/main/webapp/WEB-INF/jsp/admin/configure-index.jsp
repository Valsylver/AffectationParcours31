...
<body>
	<div class="container">
		...
		<form:form action="/admin/save-config" method="POST"
			commandName="when">
			<center>
				<button class="btn btn-success btn-large" name="commit"
					type="submit">
			...
			<div class="row">
				<div class="span4">
					<h2>
						Parcours <a href="/admin/config/modif/new/parcours"
							class="btn btn-info"><i class="icon-white icon-plus"></i></a>
					</h2>
					<br />
					...
					${pa.stringForForm}
					<br />
						<a href="/admin/config/modif/parcours/${pa.abbreviation}"
				...
				<div class="span4">
					<h2>
						Filières <a href="/admin/config/modif/new/filieres"
							class="btn btn-info"><i class="icon-white icon-plus"></i></a>
					</h2>
					<br />
					...
					${fm.stringForForm}
					<br />
						<a href="/admin/config/modif/filieres/${fm.abbreviation}"
							class="btn btn-primary btn-small pull-right">Modfier</a>
						<br />
						<br />
					</c:forEach>
				...
				<div class="span4">
					...
					<br /> <label for="secondEmail">Envoi du second mail de
					...
					<br /> <label for="endSubmission">Fin des soumissions <form:errors
							path="endSubmission">
							<br />
							<a style="color: red">La date n'a pas le bon format</a>
						</form:errors>
					...
					<div class="input-append">
						<form:input id="endSubmission" path="endSubmission" class="span2"
							value="${now}" />
						<span class="add-on">dd/MM/yyyy HH:mm</span>
					</div>
					<br />
