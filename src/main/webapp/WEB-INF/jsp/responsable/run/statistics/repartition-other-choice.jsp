		...
		<div class="row">
			<div class="span2">
				<ul class="nav nav-list">
					...
					<li class="active"><a href="/responsable/run/statistics/repartition-other-choice2">Répartition autres choix</a></li>
				</ul>
			</div>
					...
					<c:forEach var="i" begin="2" end="5" step="1">
						<c:choose>
							<c:when test="${i == choiceNumber}">
								<li class="active"><a href="/responsable/run/statistics/repartition-other-choice${i}">Choix ${i}</a></li>
							</c:when>
							<c:otherwise>
								<li><a href="/responsable/run/statistics/repartition-other-choice${i}">Choix ${i}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
				</ul>
			...
			<input id="spec" value="${specialization.abbreviation}" style="display: none">
			<input id="number" value="${choiceNumber}" style="display: none">
		</div>
	</div>
</body>
</html>