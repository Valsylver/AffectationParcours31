...
public class StatisticsServiceTest {
	...
	public void findIcStats(){
		...
		List<SimpleSpecializationWithNumber> icStats = statisticsService.findSimpleIcStats(1);
		Assert.assertTrue(icStats.size() == 10);
		int i = 0;
	...
	public void findIJsStats(){
		...
		List<SimpleSpecializationWithNumber> jsStats = statisticsService.findSimpleJsStats(1);
		Assert.assertTrue(jsStats.size() == 10);
		int i = 0;
